package com.q2l3ntk.tetrisnew.views
...
import com.q2l3ntk.tetrisnew.constants.CellConstants
import com.q2l3ntk.tetrisnew.GameActivity
import com.q2l3ntk.tetrisnew.constants.FieldConstants
import com.q2l3ntk.tetrisnew.models.AppModel
import com.q2l3ntk.tetrisnew.models.Block
...
class TetrisView : View {
    ...
    private data class Dimension(val width: Int, val heigth: Int)
    ...
    private fun updateScores() {
        ...
        activity?.tvHighScore?.text = "${activity?.appReferences?.getHighScore()}"
    }
    ...
    private fun drawFrame(canvas: Canvas) {
        ...
        canvas.drawRect(frameOffset.width.toFloat(),
            frameOffset.heigth.toFloat(), width -
            frameOffset.width.toFloat(),
            height - frameOffset.heigth.toFloat(), paint)
    }
    ...
    private fun drawCell(canvas: Canvas, x: Int, y: Int, rgbColor: Int) {
        ...
        val top: Float = (frameOffset.heigth + y * cellSize.heigth + BLOCK_OFFSET).toFloat()
        val left: Float = (frameOffset.width + x * cellSize.width + BLOCK_OFFSET).toFloat()
        val bottom: Float = (frameOffset.heigth + (y + 1) * cellSize.heigth - BLOCK_OFFSET).toFloat()
